...
opt = struct('ss',false,'sim_na',true,'fcor',false,'default_sd',false,'output_display',true,'dfbase',1e-6,'conf_lvl',0.95,'multistart',1,'reinit',true);
...
opt.conf_custom = [];
opt.conf_step = 10; %expected number of steps required to reach threshold chi2 value
